...
const Product = () => {
    ...
    const [filterListProduct, setFilterListProduct] = useState([]);
    ...
    function handleSearch(e) {
        if (e.key === 'Enter') {
            const listProductFilterSearch = refListProduct.current.filter(item => item.name.toLowerCase().includes(keySearch.toLowerCase()))
            setListProduct(listProductFilterSearch)
        }
    }
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            {filterListProduct && filterListProduct.length > 0 ?
                                                <>
                                                    {
                                                        filterListProduct.map((item, index) => {
                                                            return (
                                                                <tr key={`row ${index}`} >
