                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="icon-box">
                                <i className="fa-solid fa-briefcase bi bi-briefcase"></i>
                        ...
                        <div className="col-md-6 mt-4 mt-md-0">
                            <div className="icon-box">
                                <i className="fa-solid fa-list-check bi bi-card-checklist"></i>
                        ...
                        <div className="col-md-6 mt-4 mt-md-0">
                            <div className="icon-box">
                                <i className="fa-solid fa-chart-simple bi bi-card-checklist"></i>
                        ...
                        <div className="col-md-6 mt-4 mt-md-0">
                            <div className="icon-box">
                                <i className="fa-solid fa-binoculars bi bi-binoculars"></i>
                        ...
                        <div className="col-md-6 mt-4 mt-md-0">
                            <div className="icon-box">
                                <i className="fa-regular fa-sun bi bi-brightness-high"></i>
                        ...
                        <div className="col-md-6 mt-4 mt-md-0">
                            <div className="icon-box">
                                <i className="fa-solid fa-suitcase bi bi-calendar4-week"></i>
